...
export default function StudentPage() {
    ...
    if (isLoading) {
        return (
            <div className='p-5'>
                <DataTableSkeleton columnCount={10} filterableColumnCount={2} searchableColumnCount={1} />
            </div>
        )
    }
    ...
    return (
      ...
      /> */}
            <StudentsTable users={users} page={page} totalUsers={totalUsers} pageCount={pageCount} />
        </div>
    )
}
